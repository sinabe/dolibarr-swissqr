 ...
 */
class pdf_swissqrone extends ModelePDFFactures
{
	 /**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "SwissQR one";
		$this->description = 'Swiss QR invoice on one page';
		...
		if ($conf->facture->dir_output) {
			...
			if (file_exists($dir)) {
				...
				if ($pagenb == 1) {
					...
					$this->_tableau($pdf, $tab_top, $this->page_hauteur - $tab_top - $heightforinfotot - $heightforfreetext - 105, 0, $outputlangs, 0, 0, $object->multicurrency_code);
					$bottomlasttab = $this->page_hauteur - $heightforinfotot - $heightforfreetext + 1 -105;
				} else {
